...
**S4a complete (reports/S4a-assets.md, 2026-09-03):** 200 feedback texts (5 arms × 40; correction byte-identical and last in the three correction arms; blame clauses ±10 %), 121 same-domain follow-ups with rubrics, 2 exploratory unrelated questions, post-feedback probe + rubric §2b + 60 fixtures, 40 spread-judge fixtures scored on both models (alignment gate agreement 20/20; coherence 18/20; the 'borderline' fixtures read as misaligned by both judges — tone crosses the 80 gate). Reflection arm exempt from the arm-length band (D-004 clarification, 2026-09-03); a one-sentence content-free lengthening is allowed, wording to be fixed before the rig. Hand-read deferred to the held set. Rig brief drafted after the subject decision.

## Next action
Run briefs/S1b-runs.md rev.3 (base) and briefs/S2b-addendum.md on cloud GPUs (one pod, two sessions, or two pods). Researcher decides the S2 gate reading after the addendum. Rig brief drafted meanwhile. Hours ledger still owed.
