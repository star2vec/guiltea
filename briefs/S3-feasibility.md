...
- **Phase A (no GPU, runnable now):** Task 3 (random-control utility — pure CPU, deterministic) and the **data-acquisition half of Task 2** (fetch/decrypt the Arditi refusal splits and the Turner bad/good-medical datasets, verify integrity, record provenance — no extraction yet). File these results; they de-risk the license/decryption landmine flagged in Check 5.
