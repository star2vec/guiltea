...
**Stage:** S2, GPU half (PLAN §S2). Design fixed in S2-plan.md and DECISIONS D-018, D-020; passage sets signed off 2026-09-03 (`reports/S2a-passages.md`). **Dispatch-ready 2026-09-03** (S3 Phase B merged; the persona axis is in `directions/dirs_8B_base_sweep.pt`).
