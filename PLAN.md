...
**S1 — Modes: produce and verify. (~4h)**
...
**S3 — The rig. (~4h; parallel with S1/S2 where independent)**
...
**S5 — Steering and the honest test. (~4h; only if S2 validated)**
...
**S6 — Write-up. (~2h + the 3 writing days)**
